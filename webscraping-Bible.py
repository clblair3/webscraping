...
#to split up specific verses
for section_verses in page_verses: 
    verse_list = section_verses.text.split(".") #this will keep chanign with every section

    for v in verse_list:
        myverses.append(v)

#to find a random chapter 
myverse = random.choice(myverses)
